...
if ( ! function_exists( 'test_work_setup' ) ) :
	...
	function test_work_setup() {
		...
		register_nav_menus( array(
			'menu-1' => esc_html__( 'Primary', 'test-work' ),
		) );
		...
		add_theme_support( 'custom-background', apply_filters( 'test_work_custom_background_args', array(
...
function test_work_scripts() {
	wp_enqueue_style( 'test-work-style', get_stylesheet_uri() );

	wp_enqueue_script( 'test-work-navigation', get_template_directory_uri() . '/js/navigation.js', array(), '20151215', true );

	wp_enqueue_script( 'test-work-skip-link-focus-fix', get_template_directory_uri() . '/js/skip-link-focus-fix.js', array(), '20151215', true );
